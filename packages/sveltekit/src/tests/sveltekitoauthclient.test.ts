...
import { type OpenIdConfiguration, CrossauthError, ErrorCode } from '@crossauth/common';
import {  makeServer, getAccessToken } from './testshared';
...
async function oauthLogin () {
    ...
    return {server, authServer, sessionCookieValue, sessionId, access_token, refresh_token, keyStorage};
};
