...
export type GrantType = "authorization_code" | "implicit" | "client_credentials" | "device_code" | "password" | "refresh_token" | "http://auth0.com/oauth/grant-type/mfa-otp" | "http://auth0.com/oauth/grant-type/mfa-oob";
