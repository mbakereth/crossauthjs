...
<svelte:head>
    <title>Change Password for {data.editUser.username}</title>
</svelte:head>
<h1>Change Password for {data.editUser.username}</h1>

{#if form?.success}
    <p class="bg-success p-2 rounded text-slate-900">The user's password has been changed</p>
